...
namespace pog {
  ...
  public:
    ...
    TokenBuilder(GrammarType* grammar, TokenizerType* tokenizer)
        : _grammar(grammar), _tokenizer(tokenizer), _pattern("$"),
    ...
    TokenBuilder(GrammarType* grammar, TokenizerType* tokenizer, const std::string& pattern)
        : _grammar(grammar), _tokenizer(tokenizer), _pattern(pattern),
