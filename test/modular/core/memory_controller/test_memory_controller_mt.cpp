...
TEST_F(mc_mt_fail_test, LOAD8) {
  ASSERT_EXIT(mcmt.load8(counter, BYTE), ::testing::ExitedWithCode(1), "");
}

TEST_F(mc_mt_fail_test, LOAD16) {
  ASSERT_EXIT(mcmt.load16(counter, WORD), ::testing::ExitedWithCode(1), "");
}

TEST_F(mc_mt_fail_test, LOAD32) {
  ASSERT_EXIT(mcmt.load32(counter, DWORD), ::testing::ExitedWithCode(1), "");
}

TEST_F(mc_mt_fail_test, LOAD64) {
  ASSERT_EXIT(mcmt.load64(counter, QWORD), ::testing::ExitedWithCode(1), "");
}

TEST_F(mc_mt_fail_test, FETCH8) {
  ASSERT_EXIT(mcmt.fetch8(counter), ::testing::ExitedWithCode(1), "");
}

TEST_F(mc_mt_fail_test, FETCH16) {
  ASSERT_EXIT(mcmt.fetch16(counter), ::testing::ExitedWithCode(1), "");
}

TEST_F(mc_mt_fail_test, FETCH32) {
  ASSERT_EXIT(mcmt.fetch32(counter), ::testing::ExitedWithCode(1), "");
}

TEST_F(mc_mt_fail_test, FETCH64) {
  ASSERT_EXIT(mcmt.fetch64(counter), ::testing::ExitedWithCode(1), "");
}
