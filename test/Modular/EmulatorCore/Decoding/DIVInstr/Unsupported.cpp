...
TEST_F(DECODER_TEST, DIV_INSTR_IMM_B8) {
  ...
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b8 << 6) | HyperCPU::OperandTypes::IMM);
  ++counter;
...
TEST_F(DECODER_TEST, DIV_INSTR_IMM_B16) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b16 << 6) | HyperCPU::OperandTypes::IMM);
  ++counter;
...
TEST_F(DECODER_TEST, DIV_INSTR_IMM_B32) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b32 << 6) | HyperCPU::OperandTypes::IMM);
  ++counter;
...
TEST_F(DECODER_TEST, DIV_INSTR_R_IMM_B8) {
  ...
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b8 << 6) | HyperCPU::OperandTypes::R_IMM);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load8(counter, 0x55);
...
TEST_F(DECODER_TEST, DIV_INSTR_R_IMM_B16) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b16 << 6) | HyperCPU::OperandTypes::R_IMM);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load16(counter, 0x5555);
...
TEST_F(DECODER_TEST, DIV_INSTR_R_IMM_B32) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b32 << 6) | HyperCPU::OperandTypes::R_IMM);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load32(counter, 0x55555555);
...
TEST_F(DECODER_TEST, DIV_INSTR_R_IMM_B64) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b64 << 6) | HyperCPU::OperandTypes::R_IMM);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load64(counter, 0x5555555555555555);
...
TEST_F(DECODER_TEST, DIV_INSTR_M_R_B8) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b8 << 6) | HyperCPU::OperandTypes::M_R);
  ++counter;
  decoder.mem_controller->Load64(counter, MEM_PTR);
  counter += 8;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X7);
...
TEST_F(DECODER_TEST, DIV_INSTR_M_R_B16) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b16 << 6) | HyperCPU::OperandTypes::M_R);
  ++counter;
  decoder.mem_controller->Load64(counter, MEM_PTR);
  counter += 8;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X7);
...
TEST_F(DECODER_TEST, DIV_INSTR_M_R_B32) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b32 << 6) | HyperCPU::OperandTypes::M_R);
  ++counter;
  decoder.mem_controller->Load64(counter, MEM_PTR);
  counter += 8;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X7);
...
TEST_F(DECODER_TEST, DIV_INSTR_M_R_B64) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b64 << 6) | HyperCPU::OperandTypes::M_R);
  ++counter;
  decoder.mem_controller->Load64(counter, MEM_PTR);
  counter += 8;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X7);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_R_B8) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b8 << 6) | HyperCPU::OperandTypes::RM_R);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X7);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_R_B16) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b16 << 6) | HyperCPU::OperandTypes::RM_R);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X7);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_R_B32) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b32 << 6) | HyperCPU::OperandTypes::RM_R);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X7);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_R_B64) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b64 << 6) | HyperCPU::OperandTypes::RM_R);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X7);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_M_B8) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b8 << 6) | HyperCPU::OperandTypes::RM_M);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load64(counter, MEM_PTR);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_M_B16) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b16 << 6) | HyperCPU::OperandTypes::RM_M);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load64(counter, MEM_PTR);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_M_B32) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b32 << 6) | HyperCPU::OperandTypes::RM_M);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load64(counter, MEM_PTR);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_M_B64) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b64 << 6) | HyperCPU::OperandTypes::RM_M);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load64(counter, MEM_PTR);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_IMM_B8) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b8 << 6) | HyperCPU::OperandTypes::RM_IMM);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load8(counter, 0x55);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_IMM_B16) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b16 << 6) | HyperCPU::OperandTypes::RM_IMM);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load16(counter, 0x5555);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_IMM_B32) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b32 << 6) | HyperCPU::OperandTypes::RM_IMM);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load32(counter, 0x55555555);
...
TEST_F(DECODER_TEST, DIV_INSTR_RM_IMM_B64) {
  decoder.mem_controller->Load16(counter, HyperCPU::DIV);
  counter += 2;
  decoder.mem_controller->Load8(counter, (HyperCPU::Mode::b64 << 6) | HyperCPU::OperandTypes::RM_IMM);
  ++counter;
  decoder.mem_controller->Load8(counter, HyperCPU::Registers::X3);
  ++counter;
  decoder.mem_controller->Load64(counter, 0x5555555555555555);
