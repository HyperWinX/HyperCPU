...
TEST(INSTRUCTIONS, INC_b8_R){
    ...
    *reinterpret_cast<uint8_t*>(&cpu._xRegs[0] + 2) = 10;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
    EXPECT_EQ(*reinterpret_cast<uint8_t*>(&cpu._xRegs[0] + 2), 11);
    cpu.CleanUp();
}
...
TEST(INSTRUCTIONS, INC_b16_R){
    ...
    cpu._memory[0x0103] = HLT;
    *reinterpret_cast<uint16_t*>(&cpu._xRegs[0] + 2) = 10;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
    EXPECT_EQ(*reinterpret_cast<uint8_t*>(&cpu._xRegs[0] + 2), 11);
    cpu.CleanUp();
}
...
TEST(INSTRUCTIONS, DEC_b8_R){
    ...
    *reinterpret_cast<uint8_t*>(&cpu._xRegs[0] + 2) = 10;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
    EXPECT_EQ(*reinterpret_cast<uint8_t*>(&cpu._xRegs[0] + 2), 9);
    cpu.CleanUp();
}
...
TEST(INSTRUCTIONS, MOV_b8_R_RM){
    ...
    *reinterpret_cast<uint8_t*>(&cpu._xRegs[1] + 2) = 0x0A;
    ...
    cpu._carry = true;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
    EXPECT_EQ(*reinterpret_cast<uint8_t*>(&cpu._xRegs[1] + 2), 5);
    cpu.CleanUp();
}
...
TEST(INSTRUCTIONS, MOV_b16_R_RM){
    ...
    *reinterpret_cast<uint16_t*>(&cpu._xRegs[1] + 2) = 0x0A0A;
    ...
    cpu._carry = true;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
    EXPECT_EQ(*reinterpret_cast<uint16_t*>(&cpu._xRegs[1] + 2), 5);
    cpu.CleanUp();
}
...
TEST(INSTRUCTIONS, MOV_b8_R_IMM){
    ...
    *reinterpret_cast<uint8_t*>(&cpu._xRegs[1] + 2) = 5;
    cpu._carry = true;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
    EXPECT_EQ(*reinterpret_cast<uint8_t*>(&cpu._xRegs[1] + 2), 0x0A);
    cpu.CleanUp();
}
...
TEST(INSTRUCTIONS, MOV_b16_R_IMM){
    ...
    *reinterpret_cast<uint16_t*>(&cpu._xRegs[1] + 2) = 5;
    cpu._carry = true;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
    EXPECT_EQ(*reinterpret_cast<uint16_t*>(&cpu._xRegs[1] + 2), 0x0A0A);
    cpu.CleanUp();
}
...
TEST(INSTRUCTIONS, MOV_b32_R_IMM){
    ...
    *reinterpret_cast<uint32_t*>(&cpu._xRegs[1]) = 5;
    cpu._carry = true;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
    EXPECT_EQ(*reinterpret_cast<uint32_t*>(&cpu._xRegs[1]), 0x0A0A0A0A);
    cpu.CleanUp();
}
...
TEST(INSTRUCTIONS, MOV_b8_R_M){
    ...
    *reinterpret_cast<uint8_t*>(&cpu._xRegs[1] + 3) = 5;
    cpu._carry = true;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
    EXPECT_EQ(*reinterpret_cast<uint8_t*>(&cpu._xRegs[1] + 3), 0x0A);
    cpu.CleanUp();
}
...
TEST(INSTRUCTIONS, PUSH_b8_R){
    ...
    cpu._memory[0x0102] = HyperCPU::xlh0;
    cpu._memory[0x0103] = HLT;
    *reinterpret_cast<uint8_t*>(&cpu._xRegs[0] + 2) = 0xA6;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
...
TEST(INSTRUCTIONS, PUSH_b16_R){
    ...
    cpu._memory[0x0102] = HyperCPU::xl0;
    cpu._memory[0x0103] = HLT;
    *reinterpret_cast<uint16_t*>(&cpu._xRegs[0] + 2) = 0xA6A6;
    EXPECT_EQ(cpu.Execute(), EXIT_HALT);
