...
TEST_F(CPU_TESTING, ADDWITHCARRY_b8_RM_R){
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b16_RM_R){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b32_RM_R){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b8_R_RM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b16_R_RM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b32_R_RM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b8_RM_IMM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b16_RM_IMM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b32_RM_IMM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b8_R_IMM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b16_R_IMM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b32_R_IMM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b8_RM_M){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b16_RM_M){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b32_RM_M){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b8_R_M){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b16_R_M){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b32_R_M){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b8_M_R){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b16_M_R){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b32_M_R){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b8_M_RM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b16_M_RM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b32_M_RM){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b8_R_R){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b16_R_R){
    cpu.memoryptr[0x0100] = ADC;
...
TEST_F(CPU_TESTING, ADDWITHCARRY_b32_R_R){
    cpu.memoryptr[0x0100] = ADC;
